...
_Note:_ This package superceeds the earlier [Riley computational package](https://github.com/aelzenaar/riley).
...
Features of this package include:
 ...
 - close integration with [pandas](https://pandas.pydata.org/) and related visualisation tools, especially [HoloViews](https://holoviews.org/)
...
Future features may include, time-permitting:
 ...
 - integration with [https://www.math.uic.edu/t3m/SnapPy/](SnapPy)
